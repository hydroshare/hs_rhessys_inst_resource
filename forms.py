...
class InputForm(forms.Form):
    ...
    git_username = forms.CharField(label="git user name", max_length=50)
    git_password = forms.CharField(label="git password", widget=forms.PasswordInput())
    commit_id = forms.CharField(label="git commit id", max_length=50)
    git_branch = forms.CharField(label="git branch", max_length=50)
    model_command_line_parameters = forms.CharField(label="model command line parameters", max_length=50)
