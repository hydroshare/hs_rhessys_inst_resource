...
class InputForm(forms.Form):
    ...
    model_desc = forms.CharField(label="Model description", max_length=500, widget=forms.TextInput(attrs={'size':80}))
    study_area_bbox = forms.CharField(label="Study area bounding box", max_length = 50, widget=forms.TextInput(attrs={'size':80}))
    git_repo = forms.URLField(label="git repository", max_length=500, widget=forms.TextInput(attrs={'size':80}))
    ...
    commit_id = forms.CharField(label="git commit id", max_length=50, widget=forms.TextInput(attrs={'size':80}))
    ...
    project_name = forms.CharField(label="project name", max_length=100, widget=forms.TextInput(attrs={'size':80}))